...
pub fn generate_keypair() -> SigningKey {
    ...
    let ml_dsa_kp = ml_dsa::MlDsa44::key_gen(&mut UnwrapErr(SysRng));

    let sk2 = ml_dsa_kp.signing_key().clone();
    let vk2 = ml_dsa_kp.verifying_key();
    ...
    let mut tr = sha3::Shake256::default();
